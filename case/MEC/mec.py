...
class M_ec():
    ...
    def add(self,url):
        ...
        try:
            ...
            sleep(2)
            WebDriverWait(self.d,30,0.5).until(lambda ele:self.d.find_element_by_xpath('/html/body/div[3]/div[1]/div[1]/ul/li[27]'))
            self.d.find_element_by_xpath('/html/body/div[3]/div[1]/div[1]/ul/li[27]').click()
            sleep(1)
            #选择厂商
    ...
    def select(self,name,cs):
        ...
        sleep(1)
        self.d.find_element_by_xpath('//*[@id="index"]/div[2]/div[2]/div/div[2]/div[1]/form/div[2]/div/div/div/input').send_keys(cs)
        sleep(1)
    ...
    def delete(self):
        ...
        sleep(2)
        WebDriverWait(self.d, 60, 1).until(lambda ele: self.d.find_element_by_xpath('//*[@id="index"]/div[2]/div[2]/div/div[2]/div[2]/div[2]/div[1]/div[3]/table/tbody/tr[1]/td[5]/div/button[2]/span'))
        self.d.find_element_by_xpath('//*[@id="index"]/div[2]/div[2]/div/div[2]/div[2]/div[2]/div[1]/div[3]/table/tbody/tr[1]/td[5]/div/button[2]/span').click()
        sleep(1)
        try:
