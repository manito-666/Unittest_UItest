...
class M_ec():
    ...
    def add(self,url):
        ...
        try:
            ...
            sleep(2)
            WebDriverWait(self.d,30,0.5).until(lambda ele:self.d.find_element_by_xpath('/html/body/div[4]/div[1]/div[1]/ul/li[20]'))
            self.d.find_element_by_xpath('/html/body/div[4]/div[1]/div[1]/ul/li[20]').click()
            sleep(1)
            Log().info("选择厂商")
    ...
    def select(self):
        ...
        sleep(1)
        Log().info("选取首个专网租户")
        WebDriverWait(self.d,30,1).until(lambda ele:self.d.find_element_by_xpath('//*[@id="index"]/div[2]/div[2]/div/div[2]/div[1]/form/div[1]/div/div/div[1]/span/span/i'))
        self.d.find_element_by_xpath('//*[@id="index"]/div[2]/div[2]/div/div[2]/div[1]/form/div[1]/div/div/div[1]/span/span/i').click()
        WebDriverWait(self.d,30,1).until(lambda ele:self.d.find_element_by_xpath(
            '/html/body/div[2]/div[1]/div[1]/ul/li[2]'))
        self.d.find_element_by_xpath('/html/body/div[2]/div[1]/div[1]/ul/li[2]').click()
        sleep(1)
        Log().info("选取厂商")
        self.d.find_element_by_xpath('//*[@id="index"]/div[2]/div[2]/div/div[2]/div[1]/form/div[2]/div/div/div[1]/span/span/i').click()
        sleep(1)
