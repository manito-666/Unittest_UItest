...
class M_ec():
    ...
    def add(self,url):
        ...
        try:
            ...
            sleep(2)
            WebDriverWait(self.d,30,0.5).until(lambda ele:self.d.find_element_by_xpath('/html/body/div[3]/div[1]/div[1]/ul/li[14]'))
            self.d.find_element_by_xpath('/html/body/div[3]/div[1]/div[1]/ul/li[14]').click()
            sleep(1)
            Log().info("选择厂商")
