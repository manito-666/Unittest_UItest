...
class qie_pian():
    ...
    def add(self,name,ip,port):
        ...
        sleep(2)
        #选择等级
        self.d.find_element_by_xpath('//*[@id="index"]/div[2]/div[2]/div/div[3]/div/div[2]/form/div[2]/div/div/label[3]/span[1]/span').click()
        sleep(1)
        #选择行业
        self.d.find_element_by_xpath('//*[@id="index"]/div[2]/div[2]/div/div[3]/div/div[2]/form/div[3]/div/div/div[1]/span/span/i').click()
        sleep(1)
        self.d.find_element_by_xpath('/html/body/div[3]/div[1]/div[1]/ul/li[1]').click()
        #选择场景
        sleep(2)
        self.d.find_element_by_css_selector("#index > div.second-container > div.main-wrapper > div > div.el-dialog__wrapper > div > div.el-dialog__body > form > div:nth-child(4) > div > div > div > span > span > i").click()
        sleep(1)
        WebDriverWait(self.d, 10, 1).until(lambda ele: self.d.find_element_by_xpath('/html/body/div[4]/div[1]/div[1]/ul/li[3]'))
        self.d.find_element_by_xpath('/html/body/div[4]/div[1]/div[1]/ul/li[3]').click()
        #选择协议
        self.d.find_element_by_xpath('//*[@id="index"]/div[2]/div[2]/div/div[3]/div/div[2]/form/div[7]/div/div/div[1]/span/span/i').click()
        sleep(1)
        self.d.find_element_by_xpath("/html/body/div[5]/div[1]/div[1]/ul/li[1]").click()
        sleep(1)
        #输入ip
        self.d.find_element_by_xpath('//*[@id="index"]/div[2]/div[2]/div/div[3]/div/div[2]/form/div[8]/div/div[1]/input').send_keys(ip)
        sleep(1)
        self.d.find_element_by_xpath('//*[@id="index"]/div[2]/div[2]/div/div[3]/div/div[2]/form/div[9]/div/div/input').send_keys(ip)
        sleep(1)
        #输入端口号
        self.d.find_element_by_xpath('//*[@id="index"]/div[2]/div[2]/div/div[3]/div/div[2]/form/div[10]/div/div/input').send_keys(port)
        sleep(1)
    ...
    def select2(self):  # 根据模版名称查询
        ...
        sleep(1)
        #选择行业
        WebDriverWait(self.d,10,1).until(lambda ele:self.d.find_element_by_xpath('/html/body/div[2]/div[1]/div[1]/ul/li[1]'))
        self.d.find_element_by_xpath('/html/body/div[2]/div[1]/div[1]/ul/li[1]').click()
        sleep(1)
        self.d.find_element_by_xpath('//*[@id="index"]/div[2]/div[2]/div/div[2]/div[1]/form/div[4]/div/div/div/span/span/i').click()
        sleep(1)
        #选择场景
    ...
    def delete(self):
        ...
        WebDriverWait(self.d, 10, 1).until(lambda ele: self.d.find_element_by_xpath('/html/body/div[2]/div/div[3]/button[2]'))
